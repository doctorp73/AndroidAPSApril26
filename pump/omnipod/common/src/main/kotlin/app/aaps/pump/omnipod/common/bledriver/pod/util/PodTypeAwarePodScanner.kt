...
private class PodTypeAwareScanCollector(
    ...
    // Multiple threads may invoke onScanResult concurrently.
    ...
    override fun onScanResult(callbackType: Int, result: ScanResult) {
        ...
        // For O5, expectedPodId is intentionally not checked - see PodTypeAwarePodScanner's
        // class doc for why a fresh O5 pod's real identity isn't known before pairing.
