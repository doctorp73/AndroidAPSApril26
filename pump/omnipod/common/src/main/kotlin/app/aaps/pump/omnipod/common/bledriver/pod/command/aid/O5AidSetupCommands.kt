 ...
 * [app.aaps.pump.omnipod.common.O5PumpPlugin]'s class doc). Skipping or getting any of
...
object O5AidSetupCommands {
    ...
    fun send(session: Session) {
        ...
        // Sent 3 times identically, matching OmnipodKit's own o5SendAidSetupCommands() loop.
