...
import app.aaps.pump.omnipod.common.ui.O5CredentialImportScreen
import app.aaps.pump.omnipod.common.ui.O5CredentialImportViewModel
import app.aaps.pump.omnipod.common.ui.wizard.compose.ActivationType
import app.aaps.pump.omnipod.common.ui.wizard.compose.O5OmnipodWizardViewModel
 ...
 * [app.aaps.pump.omnipod.common.O5PumpPlugin]. Mirrors
        ...
        LaunchedEffect(overviewViewModel) {
            overviewViewModel.events.collect { event ->
                when (event) {
                    ...
                    is OmnipodOverviewEvent.ShowHistory             -> Unit // O5 has no history feature
                    ...
                    is OmnipodOverviewEvent.ShowRileyLinkPairWizard -> Unit // Not applicable for O5
                    is OmnipodOverviewEvent.ShowRileyLinkStats      -> Unit // Not applicable for O5
                    is OmnipodOverviewEvent.ShowSnackbar            -> Unit // Not used by O5
                }
            }
        }
