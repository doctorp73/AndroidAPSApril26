    ...
    companion object {
        ...
        fun parse(serviceUuids: List<ParcelUuid>?, podType: PodType): PodAdvertisement? {
            ...
            return when (podType) {
                ...
                PodType.EROS,
                PodType.UNKNOWN   -> null // Eros doesn't advertise over BLE; it uses RileyLink.
            }
        }
        ...
        private fun parseDash(serviceUuids: List<ParcelUuid>): PodAdvertisement? {
            ...
            // serviceUuids[1] (0x2470) purpose is unconfirmed; not validated, matching upstream.
        ...
        private fun parseO5(serviceUuids: List<ParcelUuid>): PodAdvertisement? {
            ...
            // Before pairing, the single 128-bit service UUID looks like:
            //   "CE1F923D-C539-48EA-7300-0AFFFFFFFE00"
            //    0         1         2         3
            //    0123456789012345678901234567890123456
            // with the 8-hex-digit PDM id embedded at offset 26 (0xFFFFFFFE = "not yet paired").
