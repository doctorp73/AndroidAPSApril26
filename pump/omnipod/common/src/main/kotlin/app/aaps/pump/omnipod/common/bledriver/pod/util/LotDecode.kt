...
data class LotDecode(
    ...
    companion object {
        ...
        private val PRODUCT_CODE: Map<Int, String> = mapOf(
            0x04 to "D1", // 'D'ash (gen 4) U100
            0x18 to "D2", // 'D'ash (gen 4) U200
            0x36 to "D5", // 'D'ash (gen 4) U500

            0x07 to "H1", // 'H'orizon (Omnipod 5) U100
            0x1B to "H2", // 'H'orizon (Omnipod 5) U200
            0x39 to "H5", // 'H'orizon (Omnipod 5) U500

            0x02 to "E1", // 'E' pod (Omnipod 6?) U100
            0x16 to "E2", // 'E' pod (Omnipod 6?) U200
            0x34 to "E5", // 'E' pod (Omnipod 6?) U500

            0x05 to "P1", // 'P're-production? U100
            0x19 to "P2", // 'P're-production? U200
            0x37 to "P5", // 'P're-production? U500
